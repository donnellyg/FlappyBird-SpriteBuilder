...
// This amounts to a header for a CGPointObject, a class which is defined within CCParalaxNode, which is hidden.
@interface CGPointObject : NSObject
{
    CGPoint _ratio;
    CGPoint _offset;
    CCNode *__unsafe_unretained _child; //weak ref // <-- whatever that means............
}
...
- (void)update:(CCTime)delta
{
    ...
    // NEW CODE I HAVE NO IDEA WHAT IT DOES //
    ...
    // END CODE I HAVE NO IDEA WHAT IT DOES //
